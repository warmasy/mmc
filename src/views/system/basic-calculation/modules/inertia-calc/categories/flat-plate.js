    ...
    subTypes: [
      {
        ...
        name: '三角形平板',
      images: [
        { src: '/images/inertia-calc/triangle-plate-model.svg', label: '模型图' },
        { src: '/images/inertia-calc/triangle-plate-formula.svg', label: '公式图' }
      ],
      ...
      },
      {
        ...
        name: '矩形',
      images: [
        { src: '/images/inertia-calc/rect-plate-model.svg', label: '模型图' },
        { src: '/images/inertia-calc/rect-plate-formula.svg', label: '公式图' }
      ],
      ...
      },
      {
        ...
        name: '梯形',
      images: [
        { src: '/images/inertia-calc/trapezoid-plate-model.svg', label: '模型图' },
        { src: '/images/inertia-calc/trapezoid-plate-formula.svg', label: '公式图' }
      ],
      ...
      },
      {
        ...
        name: '正n边形',
      images: [
        { src: '/images/inertia-calc/regular-n-polygon-model.svg', label: '模型图' },
        { src: '/images/inertia-calc/regular-n-polygon-formula.svg', label: '公式图' }
      ],
      ...
      },
      {
        ...
        name: '圆板',
      images: [
        { src: '/images/inertia-calc/circle-plate-model.svg', label: '模型图' },
        { src: '/images/inertia-calc/circle-plate-formula.svg', label: '公式图' }
      ],
      ...
      },
      {
        ...
        name: '半圆板',
      images: [
        { src: '/images/inertia-calc/semicircle-plate-model.svg', label: '模型图' },
        { src: '/images/inertia-calc/semicircle-plate-formula.svg', label: '公式图' }
      ],
        params: { m: { name: '质量 m', unit: 'kg', default: 1, min: 0, step: 0.1, precision: 4 }, R: { name: '半径 R', unit: 'm', default: 0.2, min: 0, step: 0.01, precision: 4 } },
      ...
      },
      {
        ...
        name: '圆环',
      images: [
        { src: '/images/inertia-calc/ring-plate-model.svg', label: '模型图' },
        { src: '/images/inertia-calc/ring-plate-formula.svg', label: '公式图' }
      ],
      ...
      },
      {
        ...
        name: '扇形',
      images: [
        { src: '/images/inertia-calc/sector-plate-model.svg', label: '模型图' },
        { src: '/images/inertia-calc/sector-plate-formula.svg', label: '公式图' }
      ],
      ...
      },
      {
        ...
        name: '弓形',
      images: [
        { src: '/images/inertia-calc/segment-plate-model.svg', label: '模型图' },
        { src: '/images/inertia-calc/segment-plate-formula.svg', label: '公式图' }
      ],
      ...
      },
      {
        ...
        name: '椭圆形',
      images: [
        { src: '/images/inertia-calc/ellipse-plate-model.svg', label: '模型图' },
        { src: '/images/inertia-calc/ellipse-plate-formula.svg', label: '公式图' }
      ],
      ...
      },
      {
        ...
        name: '抛物线型',
      images: [
        { src: '/images/inertia-calc/parabola-plate-model.svg', label: '模型图' },
        { src: '/images/inertia-calc/parabola-plate-formula.svg', label: '公式图' }
      ],
      ...
      },
      {
        ...
        name: '矩形棱柱',
      images: [
        { src: '/images/inertia-calc/rect-prism-plate-model.svg', label: '模型图' },
        { src: '/images/inertia-calc/rect-prism-plate-formula.svg', label: '公式图' }
      ],
      ...
      },
      {
        ...
        name: '正直角锥柱',
      images: [
        { src: '/images/inertia-calc/right-pyramid-plate-model.svg', label: '模型图' },
        { src: '/images/inertia-calc/right-pyramid-plate-formula.svg', label: '公式图' }
      ],
      ...
      },
      {
        ...
        name: '正三角柱',
      images: [
        { src: '/images/inertia-calc/triangular-prism-plate-model.svg', label: '模型图' },
        { src: '/images/inertia-calc/triangular-prism-plate-formula.svg', label: '公式图' }
      ],
