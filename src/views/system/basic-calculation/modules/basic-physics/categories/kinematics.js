  ...
  subTypes: [
    {
      ...
      name: '匀速直线运动',
      images: [
        { src: '/images/basic-physics/uniform-motion-model.svg', label: '模型图' },
        { src: '/images/basic-physics/uniform-motion-formula.svg', label: '公式图' }
      ],
      params: {
    ...
    },
    {
      ...
      name: '匀加速直线运动',
      images: [
        { src: '/images/basic-physics/uniform-acceleration-model.svg', label: '模型图' },
        { src: '/images/basic-physics/uniform-acceleration-formula.svg', label: '公式图' }
      ],
      params: {
    ...
    },
    {
      ...
      name: '圆周运动线速度',
      images: [
        { src: '/images/basic-physics/circular-linear-velocity-model.svg', label: '模型图' },
        { src: '/images/basic-physics/circular-linear-velocity-formula.svg', label: '公式图' }
      ],
      params: {
    ...
    },
    {
      ...
      name: '圆周运动角速度',
      images: [
        { src: '/images/basic-physics/circular-angular-velocity-model.svg', label: '模型图' },
        { src: '/images/basic-physics/circular-angular-velocity-formula.svg', label: '公式图' }
      ],
      params: {
        T: { name: '周期 T', unit: 's', default: 1, step: 0.1, precision: 4 }
      },
    ...
    },
    {
      ...
      name: '向心加速度',
      images: [
        { src: '/images/basic-physics/centripetal-acceleration-model.svg', label: '模型图' },
        { src: '/images/basic-physics/centripetal-acceleration-formula.svg', label: '公式图' }
      ],
      params: {
